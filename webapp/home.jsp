    ...
    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="RegisterServletHome" method="post" id="registerForm">
            ...
            <div class="row g-4" id="restaurantContainer">
                ...
                <div class="col-12 col-md-6 col-lg-4 restaurant-item" data-cuisine="<%= restaurant.getCuisineType() %>">
                    <div class="card restaurant-card">
                        <img src="<%= restaurant.getImgPath() %>" class="card-img-top" alt="<%= restaurant.getName() %>">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="badge bg-success"><i class="bi bi-star-fill"></i> <%= restaurant.getRatings() %></span>
                                <span class="text-muted small"><i class="bi bi-clock"></i> <%= restaurant.getEta() %> mins</span>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="mb-3 text-white">Developed & Maintained by Suresh M</p>
