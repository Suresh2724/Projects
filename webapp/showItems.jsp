...
<body>
    ...
    <div class="container order-details-container">
        <div class="order-header">
            ...
            <p class="text-muted mb-0">Order #<%= request.getParameter("orderId") %></p>
        </div>

        <%
            List<OrderItems> orderItemsList = (List<OrderItems>) session.getAttribute("orderItemsList");
        ...
        %>
            <div class="order-items">
                ...
                %>
                    <div class="item-card">
                        <img src="https://via.placeholder.com/80" alt="Food item" class="item-image">
