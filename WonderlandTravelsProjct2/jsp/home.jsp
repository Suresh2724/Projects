...
<%@ page import="com.tap.model.Feedback" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <% if (user == null) { %>
                        <li class="nav-item"><button class="btn btn-outline-light ms-2" data-bs-toggle="modal" data-bs-target="#loginModal">Login</button></li>
                        <li class="nav-item"><button class="btn btn-light ms-2" data-bs-toggle="modal" data-bs-target="#registerModal">Register</button></li>
                    <% } else { %>
                        <li class="nav-item"><span class="nav-link text-white">Welcome, <%= user.getName() %>!</span></li>
                        <li class="nav-item"><a href="getbookingservlet" class="btn btn-outline-light ms-2">My Bookings</a></li>
                        <li class="nav-item"><a href="LogoutServlet" class="btn btn-light ms-2">Logout</a></li>
                    <% } %>
                </ul>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="1tajmahal.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=1" class="btn btn-success">Book Now</a>
                                <% } else { %>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="2colosseum.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=2" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="3greatwallofchina.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=3" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="4machupichu.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=4" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="5christtheredemer.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=5" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="6petra.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=6" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="wonder-content">
                            ...
                            <div class="mt-4">
                                <a href="7chichen.jsp" class="btn btn-primary me-2">Learn More</a>
                                <% if (session.getAttribute("user") != null) { %>
                                    <a href="booking.jsp?wonderId=7" class="btn btn-success">Book Now</a>
                                <% } else { %>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#loginModal">Book Now</button>
                                <% } %>
                            </div>
