...
<section class="hero-section">
    <img src="https://images.unsplash.com/photo-1518638150340-f706e86654de?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80" alt="Chichen Itza" class="hero-image">
...
<section id="booking" class="booking-section">
    <div class="container">
        ...
        <% if (isLoggedIn) { %>
            <a href="booking.jsp?wonderId=5" class="btn btn-custom btn-lg" data-aos="fade-up" data-aos-delay="400">
                Book Your Tour Now
            </a>
        <% } else { %>
