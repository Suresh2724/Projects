...
public class OrderHistoryDaoImpl implements OrderHistoryDao {
    ...
    public List<OrderHistory> fetchOrderHistoryByUserId(int userId) {
        ...
        String fetchQuery = """
            SELECT oh.orderHistoryId, oh.orderId, oh.userId, oh.date, oh.totalAmount, oh.status, oh.restaurantId, r.name AS restaurantName
            FROM OrderHistory oh
            INNER JOIN Restaurant r ON oh.restaurantId = r.restaurantId
            WHERE oh.userId = ?
        """;
