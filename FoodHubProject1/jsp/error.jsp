...
<body>
    <div class="error-container">
        ...
        <p class="mb-4">We're sorry, but an error occurred while processing your request. Please try again later or contact our support team if the problem persists.</p>
